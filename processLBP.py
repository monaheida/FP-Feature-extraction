...
def getLBPfeatures(file):
    ...
    image_plot.set_title("LBP image", fontsize=20)
    ...
    current_plot.set_title("LBP histogram", fontsize=20)
    current_plot.set_xlabel("Intensity", fontsize = 18)
    current_plot.set_ylabel("Number of pixels", fontsize = 18)
